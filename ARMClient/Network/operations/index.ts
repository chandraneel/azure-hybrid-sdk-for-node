...
export { LoadBalancers, LoadBalancerBackendAddressPools,
...
Routes, Usages, VirtualNetworks, Subnets, VirtualNetworkPeerings,
VirtualNetworkGateways, VirtualNetworkGatewayConnections, LocalNetworkGateways };
