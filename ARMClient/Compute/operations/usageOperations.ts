...
export class UsageOperations {
   ...
   */
  async listWithHttpOperationResponse(location: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse<Models.ListUsagesResult>> {
      ...
      if (statusCode === 200) {
        ...
        try {
          if (parsedResponse != undefined) {
            const resultMapper = Mappers.ListUsagesResult;
   ...
   * @reject {Error|ServiceError} The error object.
   */
  async listNextWithHttpOperationResponse(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse<Models.ListUsagesResult>> {
  ...
  list(location: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<Models.ListUsagesResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
    let cb = callback as msRest.ServiceCallback<Models.ListUsagesResult>;
    if (!callback) {
      return this.listWithHttpOperationResponse(location, options).then((operationRes: msRest.HttpOperationResponse) => {
        return Promise.resolve(operationRes.parsedBody as Models.ListUsagesResult);
      }).catch((err: Error) => {
        return Promise.reject(err);
      });
    } else {
      msRest.promiseToCallback(this.listWithHttpOperationResponse(location, options))((err: Error, data: msRest.HttpOperationResponse) => {
        ...
        let result = data.parsedBody as Models.ListUsagesResult;
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<Models.ListUsagesResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
