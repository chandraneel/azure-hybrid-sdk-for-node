...
var Mappers = require("../models/localNetworkGatewaysMappers");
...
var LocalNetworkGateways = /** @class */ (function () {
                    ...
                    case 5:
                        ...
                        try {
                            if (parsedResponse != undefined) {
                                resultMapper = Mappers.LocalNetworkGateway;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    LocalNetworkGateways.prototype.updateTagsWithHttpOperationResponse = function (resourceGroupName, localNetworkGatewayName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options)];
                    case 2:
                        initialResult = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.LocalNetworkGatewayListResult;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
    ...
    LocalNetworkGateways.prototype.beginCreateOrUpdateWithHttpOperationResponse = function (resourceGroupName, localNetworkGatewayName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            var apiVersion, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, parsedResponse, resultMapper, deserializationError1, err_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiVersion = '2017-10-01';
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    ...
                                    mapper: __assign({}, Mappers.LocalNetworkGateway, { required: true })
                                },
     ...
     * @reject {Error|ServiceError} The error object.
     */
    LocalNetworkGateways.prototype.beginUpdateTagsWithHttpOperationResponse = function (resourceGroupName, localNetworkGatewayName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LocalNetworkGateways.prototype.createOrUpdate = function (resourceGroupName, localNetworkGatewayName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    LocalNetworkGateways.prototype.get = function (resourceGroupName, localNetworkGatewayName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LocalNetworkGateways.prototype.deleteMethod = function (resourceGroupName, localNetworkGatewayName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LocalNetworkGateways.prototype.updateTags = function (resourceGroupName, localNetworkGatewayName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.updateTagsWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.updateTagsWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LocalNetworkGateways.prototype.beginCreateOrUpdate = function (resourceGroupName, localNetworkGatewayName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LocalNetworkGateways.prototype.beginDeleteMethod = function (resourceGroupName, localNetworkGatewayName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LocalNetworkGateways.prototype.beginUpdateTags = function (resourceGroupName, localNetworkGatewayName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, localNetworkGatewayName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
