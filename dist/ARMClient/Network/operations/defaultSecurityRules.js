...
var Mappers = require("../models/defaultSecurityRulesMappers");
...
var DefaultSecurityRules = /** @class */ (function () {
    ...
    DefaultSecurityRules.prototype.get = function (resourceGroupName, networkSecurityGroupName, defaultSecurityRuleName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, networkSecurityGroupName, defaultSecurityRuleName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
