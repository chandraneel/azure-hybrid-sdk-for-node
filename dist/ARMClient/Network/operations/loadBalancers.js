...
var Mappers = require("../models/loadBalancersMappers");
...
var LoadBalancers = /** @class */ (function () {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.LoadBalancer;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    LoadBalancers.prototype.updateTagsWithHttpOperationResponse = function (resourceGroupName, loadBalancerName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options)];
                    case 2:
                        initialResult = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.LoadBalancerListResult;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    ...
                                    mapper: __assign({}, Mappers.LoadBalancer, { required: true })
                                },
     ...
     * @reject {Error|ServiceError} The error object.
     */
    LoadBalancers.prototype.beginUpdateTagsWithHttpOperationResponse = function (resourceGroupName, loadBalancerName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LoadBalancers.prototype.deleteMethod = function (resourceGroupName, loadBalancerName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, loadBalancerName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    LoadBalancers.prototype.get = function (resourceGroupName, loadBalancerName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, loadBalancerName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LoadBalancers.prototype.createOrUpdate = function (resourceGroupName, loadBalancerName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LoadBalancers.prototype.updateTags = function (resourceGroupName, loadBalancerName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.updateTagsWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.updateTagsWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LoadBalancers.prototype.beginDeleteMethod = function (resourceGroupName, loadBalancerName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, loadBalancerName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LoadBalancers.prototype.beginCreateOrUpdate = function (resourceGroupName, loadBalancerName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    LoadBalancers.prototype.beginUpdateTags = function (resourceGroupName, loadBalancerName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, loadBalancerName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
