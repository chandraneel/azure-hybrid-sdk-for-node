...
var Mappers = require("../models/virtualNetworkGatewayConnectionsMappers");
...
var VirtualNetworkGatewayConnections = /** @class */ (function () {
                    ...
                    case 5:
                        ...
                        try {
                            if (parsedResponse != undefined) {
                                resultMapper = Mappers.VirtualNetworkGatewayConnection;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    VirtualNetworkGatewayConnections.prototype.updateTagsWithHttpOperationResponse = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options)];
                    case 2:
                        initialResult = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 5:
                        ...
                        try {
                            if (parsedResponse != undefined) {
                                resultMapper = Mappers.VirtualNetworkGatewayConnectionListEntity;
                                operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                            }
                        }
                        catch (error) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        try {
                            if (parsedResponse != undefined) {
                                resultMapper = Mappers.ConnectionSharedKey;
                                operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                            }
                        }
                        catch (error) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.VirtualNetworkGatewayConnectionListResult;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        try {
                            if (parsedResponse != undefined) {
                                resultMapper = Mappers.ConnectionResetSharedKey;
                                operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                            }
                        }
                        catch (error) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    ...
                                    mapper: __assign({}, Mappers.VirtualNetworkGatewayConnection, { required: true })
                                },
     ...
     * @reject {Error|ServiceError} The error object.
     */
    VirtualNetworkGatewayConnections.prototype.beginUpdateTagsWithHttpOperationResponse = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            var apiVersion, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_16;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiVersion = '2017-10-01';
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    parameterPath: "parameters",
                                    mapper: __assign({}, Mappers.ConnectionSharedKey, { required: true })
                                },
                                contentType: "application/json; charset=utf-8",
                                responses: {
                                    201: {
    ...
    VirtualNetworkGatewayConnections.prototype.beginResetSharedKeyWithHttpOperationResponse = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            var apiVersion, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_18;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiVersion = '2017-10-01';
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    parameterPath: "parameters",
                                    mapper: __assign({}, Mappers.ConnectionResetSharedKey, { required: true })
                                },
                                contentType: "application/json; charset=utf-8",
                                responses: {
                                    200: {
    ...
    VirtualNetworkGatewayConnections.prototype.createOrUpdate = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    VirtualNetworkGatewayConnections.prototype.get = function (resourceGroupName, virtualNetworkGatewayConnectionName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.deleteMethod = function (resourceGroupName, virtualNetworkGatewayConnectionName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.updateTags = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.updateTagsWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.updateTagsWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.setSharedKey = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.setSharedKeyWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.getSharedKey = function (resourceGroupName, virtualNetworkGatewayConnectionName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getSharedKeyWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.resetSharedKey = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.resetSharedKeyWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.beginCreateOrUpdate = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.beginDeleteMethod = function (resourceGroupName, virtualNetworkGatewayConnectionName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.beginUpdateTags = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        var cb = callback;
        if (!callback) {
            return this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.beginUpdateTagsWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.beginSetSharedKey = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginSetSharedKeyWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualNetworkGatewayConnections.prototype.beginResetSharedKey = function (resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginResetSharedKeyWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
