...
var Mappers = require("../models/inboundNatRulesMappers");
...
var InboundNatRules = /** @class */ (function () {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.InboundNatRuleListResult;
    ...
    InboundNatRules.prototype.getWithHttpOperationResponse = function (resourceGroupName, loadBalancerName, inboundNatRuleName, options) {
        return __awaiter(this, void 0, void 0, function () {
            var expand, apiVersion, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.InboundNatRule;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    ...
                                    mapper: __assign({}, Mappers.InboundNatRule, { required: true })
                                },
    ...
    InboundNatRules.prototype.deleteMethod = function (resourceGroupName, loadBalancerName, inboundNatRuleName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, loadBalancerName, inboundNatRuleName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    InboundNatRules.prototype.get = function (resourceGroupName, loadBalancerName, inboundNatRuleName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, loadBalancerName, inboundNatRuleName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    InboundNatRules.prototype.createOrUpdate = function (resourceGroupName, loadBalancerName, inboundNatRuleName, inboundNatRuleParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, loadBalancerName, inboundNatRuleName, inboundNatRuleParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    InboundNatRules.prototype.beginDeleteMethod = function (resourceGroupName, loadBalancerName, inboundNatRuleName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, loadBalancerName, inboundNatRuleName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    InboundNatRules.prototype.beginCreateOrUpdate = function (resourceGroupName, loadBalancerName, inboundNatRuleName, inboundNatRuleParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, loadBalancerName, inboundNatRuleName, inboundNatRuleParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
