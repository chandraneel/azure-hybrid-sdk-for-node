...
var Mappers = require("../models/routeFiltersMappers");
...
var RouteFilters = /** @class */ (function () {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.RouteFilter;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.RouteFilterListResult;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    ...
                                    mapper: __assign({}, Mappers.RouteFilter, { required: true })
                                },
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.sendOperationRequest(httpRequest, operationArguments, {
                                ...
                                requestBody: {
                                    parameterPath: "routeFilterParameters",
                                    mapper: __assign({}, Mappers.PatchRouteFilter, { required: true })
                                },
                                contentType: "application/json; charset=utf-8",
                                responses: {
                                    200: {
    ...
    RouteFilters.prototype.deleteMethod = function (resourceGroupName, routeFilterName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, routeFilterName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    RouteFilters.prototype.get = function (resourceGroupName, routeFilterName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, routeFilterName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    RouteFilters.prototype.createOrUpdate = function (resourceGroupName, routeFilterName, routeFilterParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, routeFilterName, routeFilterParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    RouteFilters.prototype.update = function (resourceGroupName, routeFilterName, routeFilterParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.updateWithHttpOperationResponse(resourceGroupName, routeFilterName, routeFilterParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    RouteFilters.prototype.beginDeleteMethod = function (resourceGroupName, routeFilterName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, routeFilterName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    RouteFilters.prototype.beginCreateOrUpdate = function (resourceGroupName, routeFilterName, routeFilterParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, routeFilterName, routeFilterParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    RouteFilters.prototype.beginUpdate = function (resourceGroupName, routeFilterName, routeFilterParameters, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.beginUpdateWithHttpOperationResponse(resourceGroupName, routeFilterName, routeFilterParameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
