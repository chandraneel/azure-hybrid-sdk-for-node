...
var Mappers = require("../models/networkInterfaceIPConfigurationsMappers");
...
var NetworkInterfaceIPConfigurations = /** @class */ (function () {
    ...
    NetworkInterfaceIPConfigurations.prototype.list = function (resourceGroupName, networkInterfaceName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.listWithHttpOperationResponse(resourceGroupName, networkInterfaceName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    NetworkInterfaceIPConfigurations.prototype.get = function (resourceGroupName, networkInterfaceName, ipConfigurationName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, networkInterfaceName, ipConfigurationName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
