...
var Mappers = require("../models/loadBalancerBackendAddressPoolsMappers");
...
var LoadBalancerBackendAddressPools = /** @class */ (function () {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.LoadBalancerBackendAddressPoolListResult;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.BackendAddressPool;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
    ...
    LoadBalancerBackendAddressPools.prototype.get = function (resourceGroupName, loadBalancerName, backendAddressPoolName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, loadBalancerName, backendAddressPoolName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
