...
var Mappers = require("../models/loadBalancerFrontendIPConfigurationsMappers");
...
var LoadBalancerFrontendIPConfigurations = /** @class */ (function () {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.LoadBalancerFrontendIPConfigurationListResult;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.FrontendIPConfiguration;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
    ...
    LoadBalancerFrontendIPConfigurations.prototype.get = function (resourceGroupName, loadBalancerName, frontendIPConfigurationName, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, loadBalancerName, frontendIPConfigurationName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
