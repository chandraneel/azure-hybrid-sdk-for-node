...
var Mappers = require("../models/providersMappers");
...
var Providers = /** @class */ (function () {
    ...
    Providers.prototype.listWithHttpOperationResponse = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var top, expand, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Providers.prototype.getWithHttpOperationResponse = function (resourceProviderNamespace, options) {
        return __awaiter(this, void 0, void 0, function () {
            var expand, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expand = (options && options.expand !== undefined) ? options.expand : undefined;
