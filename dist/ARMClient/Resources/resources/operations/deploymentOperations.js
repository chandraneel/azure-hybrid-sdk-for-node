...
var Mappers = require("../models/deploymentOperationsMappers");
...
var DeploymentOperations = /** @class */ (function () {
    ...
    DeploymentOperations.prototype.listWithHttpOperationResponse = function (resourceGroupName, deploymentName, options) {
        return __awaiter(this, void 0, void 0, function () {
            var top, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
