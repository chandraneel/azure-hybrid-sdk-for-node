...
var Mappers = require("../models/operationsMappers");
...
var Operations = /** @class */ (function () {
     ...
     */
    Operations.prototype.listWithHttpOperationResponse = function (options) {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.OperationListResult;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Operations.prototype.listNextWithHttpOperationResponse = function (nextPageLink, options) {
        return __awaiter(this, void 0, void 0, function () {
