...
var Mappers = require("../models/resourceSkusMappers");
...
var ResourceSkus = /** @class */ (function () {
     ...
     */
    ResourceSkus.prototype.listWithHttpOperationResponse = function (options) {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.ResourceSkusResult;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    ResourceSkus.prototype.listNextWithHttpOperationResponse = function (nextPageLink, options) {
        return __awaiter(this, void 0, void 0, function () {
