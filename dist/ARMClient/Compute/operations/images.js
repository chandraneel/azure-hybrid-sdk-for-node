...
var Mappers = require("../models/imagesMappers");
...
var Images = /** @class */ (function () {
     ...
     */
    Images.prototype.createOrUpdateWithHttpOperationResponse = function (resourceGroupName, imageName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, imageName, parameters, options)];
                    case 2:
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.deleteMethodWithHttpOperationResponse = function (resourceGroupName, imageName, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, imageName, options)];
                    case 2:
                        initialResult = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.getWithHttpOperationResponse = function (resourceGroupName, imageName, options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.listByResourceGroupWithHttpOperationResponse = function (resourceGroupName, options) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.ImageListResult;
                                    operationRes.parsedBody = this.serializer.deserialize(resultMapper, parsedResponse, 'operationRes.parsedBody');
                                }
                            }
                            catch (error) {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.listWithHttpOperationResponse = function (options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.beginCreateOrUpdateWithHttpOperationResponse = function (resourceGroupName, imageName, parameters, options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.beginDeleteMethodWithHttpOperationResponse = function (resourceGroupName, imageName, options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.listByResourceGroupNextWithHttpOperationResponse = function (nextPageLink, options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    Images.prototype.listNextWithHttpOperationResponse = function (nextPageLink, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Images.prototype.createOrUpdate = function (resourceGroupName, imageName, parameters, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.createOrUpdateWithHttpOperationResponse(resourceGroupName, imageName, parameters, options).then(function (operationRes) {
            ...
            msRest.promiseToCallback(this.createOrUpdateWithHttpOperationResponse(resourceGroupName, imageName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    Images.prototype.deleteMethod = function (resourceGroupName, imageName, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.deleteMethodWithHttpOperationResponse(resourceGroupName, imageName, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.deleteMethodWithHttpOperationResponse(resourceGroupName, imageName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    Images.prototype.get = function (resourceGroupName, imageName, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.getWithHttpOperationResponse(resourceGroupName, imageName, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(resourceGroupName, imageName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    Images.prototype.beginCreateOrUpdate = function (resourceGroupName, imageName, parameters, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, imageName, parameters, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, imageName, parameters, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    Images.prototype.beginDeleteMethod = function (resourceGroupName, imageName, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, imageName, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.beginDeleteMethodWithHttpOperationResponse(resourceGroupName, imageName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
