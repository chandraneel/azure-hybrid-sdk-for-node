...
var Mappers = require("../models/usageOperationsMappers");
...
var UsageOperations = /** @class */ (function () {
     ...
     */
    UsageOperations.prototype.listWithHttpOperationResponse = function (location, options) {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.ListUsagesResult;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    UsageOperations.prototype.listNextWithHttpOperationResponse = function (nextPageLink, options) {
        return __awaiter(this, void 0, void 0, function () {
