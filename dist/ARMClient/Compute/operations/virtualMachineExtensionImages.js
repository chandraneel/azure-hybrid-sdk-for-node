...
var Mappers = require("../models/virtualMachineExtensionImagesMappers");
...
var VirtualMachineExtensionImages = /** @class */ (function () {
     ...
     */
    VirtualMachineExtensionImages.prototype.getWithHttpOperationResponse = function (location, publisherName, type, version, options) {
                        ...
                        if (statusCode === 200) {
                            ...
                            try {
                                if (parsedResponse != undefined) {
                                    resultMapper = Mappers.VirtualMachineExtensionImage;
     ...
     * @reject {Error|ServiceError} The error object.
     */
    VirtualMachineExtensionImages.prototype.listTypesWithHttpOperationResponse = function (location, publisherName, options) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @reject {Error|ServiceError} The error object.
     */
    VirtualMachineExtensionImages.prototype.listVersionsWithHttpOperationResponse = function (location, publisherName, type, options) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, top, orderby, httpRequest, operationRes, operationArguments, statusCode, parsedResponse, resultMapper, deserializationError, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    VirtualMachineExtensionImages.prototype.get = function (location, publisherName, type, version, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.getWithHttpOperationResponse(location, publisherName, type, version, options).then(function (operationRes) {
            ...
            msRest.promiseToCallback(this.getWithHttpOperationResponse(location, publisherName, type, version, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
    ...
    VirtualMachineExtensionImages.prototype.listTypes = function (location, publisherName, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.listTypesWithHttpOperationResponse(location, publisherName, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.listTypesWithHttpOperationResponse(location, publisherName, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
    ...
    VirtualMachineExtensionImages.prototype.listVersions = function (location, publisherName, type, options, callback) {
        ...
        var cb = callback;
        if (!callback) {
            return this.listVersionsWithHttpOperationResponse(location, publisherName, type, options).then(function (operationRes) {
                return Promise.resolve(operationRes.parsedBody);
            }).catch(function (err) {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.listVersionsWithHttpOperationResponse(location, publisherName, type, options))(function (err, data) {
                if (err) {
                    return cb(err);
                }
                var result = data.parsedBody;
